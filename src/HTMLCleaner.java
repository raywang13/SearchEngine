...
public class HTMLCleaner {
	...
	public static String fetchHTML(String link) {
		...
		try {
			...
			System.err.println("Could not fetch link.");
			return "";
		}
	...
	public static String stripElement(String name, String html) {
		//		System.out.println("before stripElement: " + html);
		html = html.replaceAll("(?is)<" + name + ".+?" + name + "\\s*>",
				"");
		//		System.out.println("after stripElement: " + html);
		return html;
	}
	...
	public static String stripTags(String html) {
		//		System.out.println("before stripTags: " + html);
		html = html.replaceAll("(?is)<.+?\\s*>", "");
		//		System.out.println("after stripTags: " + html);
		return html;
	}
	...
	public static String stripEntities(String html) {
		//		System.out.println("before stripEntities: " + html);
		html = html.replaceAll("&[^\\s].+?;", "");
		//		System.out.println("after stripEntities: " + html);
		return html;
	}
}
